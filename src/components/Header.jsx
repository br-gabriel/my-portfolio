...
export default function Header() {
    ...
    return (
        <header className={`w-screen flex flex-row justify-center fixed z-10 transition-all ease-in-out duration-500 delay-100 ${ scrolled ? 'bg-gradient-to-r from-[#E4E6FF]/70 via-white/70 to-[#E4EBFF]/70 backdrop-blur drop-shadow-sm': ''}`}>
