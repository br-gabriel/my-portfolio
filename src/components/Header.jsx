...
export default function Header() {
    ...
    return (
        <header className={`w-screen flex flex-row justify-center fixed z-10 transition-all ease-in-out duration-500 delay-100 ${ scrolled ? 'bg-gradient-to-r from-violet-200/70 via-white/70 to-sky-100/70 backdrop-blur drop-shadow-sm': ''}`}>
