        ...
        <div className="flex w-full max-w-7xl flex-col items-center justify-center gap-12 px-4 py-8 md:flex-row">
          ...
          <LayoutGroup>
            <div className="flex max-w-2xl flex-col gap-5 pr-4 will-change-transform">
              ...
              >
                Meu nome é Gabriel Silva Feitosa, sou apaixonado por tecnologia
                e programação. Atualmente estou me formando em{" "}
              ...
              >
                ...
                de criar interfaces e transforma-las em código, buscando sempre
                um equilíbrio entre beleza e boa performance.
              </motion.p>
