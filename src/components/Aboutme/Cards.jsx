...
export default function Cards() {
  return (
    ...
    >
      <div className="flex min-h-[120px] w-full min-w-[270px] max-w-[300px] snap-center items-center justify-center rounded-md bg-white p-4 text-black dark:bg-black dark:text-white md:max-w-[360px]">
