...
export default function Cards() {
  return (
    <section
      className="flex w-full snap-x snap-mandatory gap-4 overflow-x-scroll p-4 drop-shadow-md scrollbar-thin scrollbar-track-transparent scrollbar-thumb-gray-300 dark:scrollbar-thumb-gray-800 md:items-center md:justify-center md:overflow-hidden"
    >
