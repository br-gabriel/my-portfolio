            ...
            >
                <swiper-slide>
                    <div className="h-40 p-2">
                        <div className="min-w-[150px] md:min-w-[250px] h-36 bg-white dark:bg-black/80 dark:text-slate-50 drop-shadow-md rounded-md flex flex-row items-center justify-center gap-5">
